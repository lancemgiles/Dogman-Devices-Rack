...
struct ThreeHold : Module {
	...
	ThreeHold() {
		...
		configParam(SCALE2_PARAM, 0.f, 1.f, 0.f, "Scale Input 2", "%", 0, 100);
		configParam(SCALE3_PARAM, 0.f, 1.f, 0.f, "Scale Input 3", "%", 0, 100);
...
struct ThreeHoldWidget : ModuleWidget {
	ThreeHoldWidget(ThreeHold* module) {
		...
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(22.023, 20.079)), module, ThreeHold::SCALE1_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(22.023, 51.3)), module, ThreeHold::SCALE2_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(22.023, 83.05)), module, ThreeHold::SCALE3_PARAM));
